...
function Postcomponent() {
    const [posts, setPosts] = useState([{
        ...
        drivelink: "",
        upload: 'https://uploads-ssl.webflow.com/5fadb14c46b287ad224b60b9/60392863c1c9a5eba8ea3cc1_FreshMenu-min.png',
    }, {
        title: 'Cure.Fit',
    ...
    return (
        <div className="place" >
            ...
            <div className="postscomp">
                ...
                }).map((post, index) => { return (<Postscard key={`${index}-${post.title}`} post={post} />); })}
            </div>
        </div>
    )
}
